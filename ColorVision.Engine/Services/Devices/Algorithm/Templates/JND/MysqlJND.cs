...
namespace ColorVision.Engine.Services.Devices.Algorithm.Templates.JDN
{
    ...
    {
        public string GetMysqlCommandName() => "恢复MysqlJDN";

        public string GetRecover()
        {
            string t_scgd_sys_dictionary_mod_master = "INSERT INTO `t_scgd_sys_dictionary_mod_master` (`id`, `code`, `name`, `pid`, `mod_type`, `create_date`, `is_enable`, `is_delete`, `remark`, `tenant_id`) VALUES (30, 'OLED.JDN.CalVas', 'JDN', NULL, 7, '2024-08-16 15:27:12', 1, 0, NULL, 0);\r\n";
