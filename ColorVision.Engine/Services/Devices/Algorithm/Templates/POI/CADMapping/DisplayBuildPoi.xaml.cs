using ColorVision.Engine.Services.Devices.Algorithm.Templates.POI.CADMapping;
...
namespace ColorVision.Engine.Services.Devices.Algorithm.Templates.CADMapping
{
    /// <summary>
