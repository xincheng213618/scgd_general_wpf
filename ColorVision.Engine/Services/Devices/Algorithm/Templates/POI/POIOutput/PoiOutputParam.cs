...
namespace ColorVision.Engine.Services.Devices.Algorithm.Templates.POI.PoiOutput
{
    public class PoiOutputParam : ParamModBase
    {
        ...
        public string? XFileName { get => GetValue(_XFileName); set { SetProperty(ref _XFileName, value); NotifyPropertyChanged(); } }
        ...
        public string? YFileName { get => GetValue(_YFileName); set { SetProperty(ref _YFileName, value); NotifyPropertyChanged(); } }
        ...
        public string? ZFileName { get => GetValue(_ZFileName); set { SetProperty(ref _ZFileName, value); NotifyPropertyChanged(); } }
        ...
        public string? uFileName { get => GetValue(_uFileName); set { SetProperty(ref _uFileName, value); NotifyPropertyChanged(); } }
        ...
        public string? vFileName { get => GetValue(_vFileName); set { SetProperty(ref _vFileName, value); NotifyPropertyChanged(); } }
        private string? _vFileName;


        public bool CCTIsEnable { get => GetValue(_CCTIsEnable); set { SetProperty(ref _CCTIsEnable, value); NotifyPropertyChanged(); } }
        private bool _CCTIsEnable;

        public string? CCTFileName { get => GetValue(_CCTFileName); set { SetProperty(ref _CCTFileName, value); NotifyPropertyChanged(); } }
        private string? _CCTFileName;

        public bool WaveIsEnable { get => GetValue(_WaveIsEnable); set { SetProperty(ref _WaveIsEnable, value); NotifyPropertyChanged(); } }
