    ...
    public partial class MainWindow : Window
    {
        ...
        private  void Window_Initialized(object sender, EventArgs e)
        {
            ...
            if (MySqlControl.GetInstance().IsConnect)
            {
                ...
                string sql2 = "ALTER TABLE `t_scgd_camera_license` MODIFY COLUMN `id` int(11) NOT NULL, MODIFY COLUMN `customer_name` varchar(64) NOT NULL DEFAULT '' COMMENT '客户名称', MODIFY COLUMN `mac_sn` varchar(255) DEFAULT NULL, MODIFY COLUMN `model` varchar(255) DEFAULT NULL, MODIFY COLUMN `value` text, MODIFY COLUMN `pid` int(11) NOT NULL, MODIFY COLUMN `create_date` datetime DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP, MODIFY COLUMN `is_enable` tinyint(1) NOT NULL DEFAULT '1', MODIFY COLUMN `is_delete` tinyint(1) NOT NULL DEFAULT '0', MODIFY COLUMN `remark` varchar(255) DEFAULT NULL; ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC;";
                MySqlControl.GetInstance().ExecuteNonQuery(sql2);
            }
