...
{
    internal class PoiMasterService : BaseService<PoiMasterModel>
    {
        ...
        protected override PoiMasterModel GetModel(DataRow item)
        {
        ...
        protected override DataRow GetRow(PoiMasterModel item, DataTable d_info)
        {
