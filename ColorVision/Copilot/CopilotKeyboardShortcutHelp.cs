...
namespace ColorVision.Copilot
{
    ...
    internal static class CopilotKeyboardShortcutHelp
    {
        ...
        [
            ...
            new("Copilot 面板", "Ctrl+Shift+C", "复制最近一条已完成回答"),
            new("Copilot 面板", "Ctrl+Alt+T", "收起或展开 Agent 任务明细"),
            ...
            new("输入框", "保存快捷键（默认 Ctrl+S）", "暂存当前草稿；空输入时恢复"),
            new("输入框", "Ctrl+E", "打开本机大段提示词编辑器"),
            new("输入框", "Ctrl+V", "优先粘贴剪贴板图片，否则正常粘贴文本"),
            new("输入框", "↑ / ↓", "移动命令或引用候选；空输入时浏览历史"),
            new("输入框", "PgUp / PgDn", "输入框无法继续滚动时按页翻阅对话"),
            new("输入框", "@", "关联文件、模板或菜单"),
            new("输入框", "/ 或 $", "打开命令与 Skill 候选"),
            new("历史搜索", "保存快捷键（默认 Ctrl+S）", "在当前会话与全部会话之间切换范围"),
        ...
        internal static string Format()
        {
            ...
            builder.AppendLine("Ctrl+S 为保存操作的默认键；主窗口内的输入框随选项中的保存快捷键配置生效。");
