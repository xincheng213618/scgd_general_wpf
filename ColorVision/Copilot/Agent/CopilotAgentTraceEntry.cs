    ...
    public sealed class CopilotAgentTraceEntry : ViewModelBase
    {
        ...
        private string BuildActivityLabel()
        {
            var (running, completed) = ToolName switch
            {
                ...
                "PreviewWorkspacePatch" or "PreviewCreateWorkspaceFile" or "PreviewWorkspaceChangeSet" or "PreviewWorkspacePatchEnvelope" => ("正在准备修改", "准备了修改"),
                "ApplyWorkspacePatch" or "ApplyCreateWorkspaceFile" or "ApplyWorkspaceChangeSet" or "ApplyWorkspacePatchEnvelope" => ("正在修改文件", "修改了文件"),
                "RollbackWorkspacePatch" or "RollbackWorkspaceChangeSet" or "RollbackWorkspacePatchEnvelope" => ("正在回滚修改", "回滚了修改"),
        ...
        private string BuildFriendlySuccessSummary()
        {
            ...
            return ToolName switch
            {
                ...
                "PreviewWorkspacePatch" or "PreviewCreateWorkspaceFile" or "PreviewWorkspaceChangeSet" or "PreviewWorkspacePatchEnvelope" => "文件修改预览已准备。",
                "ApplyWorkspacePatch" or "ApplyCreateWorkspaceFile" or "ApplyWorkspaceChangeSet" or "ApplyWorkspacePatchEnvelope" => "文件修改已完成。",
                "RollbackWorkspacePatch" or "RollbackWorkspaceChangeSet" or "RollbackWorkspacePatchEnvelope" => "文件修改已回滚。",
                "CreateFlow" => "流程已创建。",
