    ...
    public sealed class CopilotAgentTraceGroup
    {
        ...
        private static string GetCategory(string toolName)
        {
            return toolName switch
            {
                ...
                "InspectWindowsSystem" or "InspectWindowsProcesses" or "InspectWindowsServices" or "InspectTcpPort" or "InspectGitWorkingTree" or "InspectGitDiff" or "RunShellCommand" or "StartBackgroundShellCommand" or "InspectBackgroundShellCommands" or "WaitForBackgroundShellCommand" or "StopBackgroundShellCommand" => "command",
