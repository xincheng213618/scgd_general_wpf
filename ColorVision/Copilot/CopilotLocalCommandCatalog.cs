...
namespace ColorVision.Copilot
{
    ...
    public static class CopilotLocalCommandCatalog
    {
        ...
        [
            ...
            new("/tasks", "查看任务，或经原生确认停止活动与队列中的指定项", CopilotLocalCommandKind.Tasks, AcceptsArguments: true, AvailableWhileAgentRuns: true, Usage: "/tasks [stop N]", Arguments:
            [
                new("stop", "经原生确认停止任务列表中的第 N 项", AcceptsArguments: true),
            ]),
            new("/ps", "同 /tasks；查看任务或停止活动与队列中的指定项", CopilotLocalCommandKind.Tasks, AcceptsArguments: true, AvailableWhileAgentRuns: true, Usage: "/ps [stop N]", Arguments:
            [
                new("stop", "经原生确认停止任务列表中的第 N 项", AcceptsArguments: true),
            ]),
