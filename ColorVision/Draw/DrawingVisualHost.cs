    ...
    public class DrawingVisualHost : FrameworkElement
    {
        ...
        public void Render(double length)
        {
            ...
            using (var dc = visual.RenderOpen())
            {
                ...
                FormattedText formattedText1 = new FormattedText((result* ActualLength).ToString("F2") + PhysicalUnit, CultureInfo.CurrentCulture, FlowDirection.LeftToRight, new Typeface(fontFamily, FontStyles.Normal, FontWeights.Normal, FontStretches.Normal), fontSize, brush, VisualTreeHelper.GetDpi(this).PixelsPerDip);
