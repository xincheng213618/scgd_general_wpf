...
namespace ColorVision.SettingUp
{
    ...
    public class GlobalSetting:ViewModelBase
    {
        ...
        public bool IsAutoRun { get => Util.Tool.IsAutoRun(GlobalConst.AutoRunName,GlobalConst.AutoRunRegPath); set { Util.Tool.SetAutoRun(value, GlobalConst.AutoRunName, GlobalConst.AutoRunRegPath); NotifyPropertyChanged(); } }
