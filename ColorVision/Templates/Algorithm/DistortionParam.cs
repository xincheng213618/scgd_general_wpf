...
namespace ColorVision.Templates.Algorithm
{
    public class DistortionParam:ParamBase
    {
        ...
        [Category("ISIZE"), Description("ISIZE cx"), DisplayName("cx")]
        public int Width { get => GetValue(_Width); set { SetProperty(ref _Width, value); } }
        private int _Width = 16;
        [Category("ISIZE"), Description("ISIZE cy"),DisplayName("cy")]
        ...
        [Category("Blob_Threshold_Params"), Description("是否使用颜色过滤")]
        ...
        [Category("Blob_Threshold_Params"), Description("阈值每次间隔值")]
        ...
        [Category("Blob_Threshold_Params"), Description("斑点最小灰度")]
        ...
        [Category("Blob_Threshold_Params"), Description("斑点最大灰度")]
        ...
        [Category("Blob_Threshold_Params"), Description("斑点间隔距离")]
        ...
        [Category("Blob_Threshold_Params"), Description("是否使用面积过滤")]
        ...
        [Category("Blob_Threshold_Params"), Description("形状控制（圆，方(")]
        ...
        [Category("Blob_Threshold_Params"), Description("形状控制（豁口）")]
        ...
        [Category("Blob_Threshold_Params"), Description("形状控制（椭圆度）")]
        ...
        [Category("Distortion"), DisplayName("CornerType"),Description("角点提取方法")]
        public CornerType type { get => GetValue(_type); set { SetProperty(ref _type, value); } }
        private CornerType _type = CornerType.Circlepoint;
       
        [Category("Distortion"),DisplayName("SlopeType"),Description("斜率计算方法")]
        ...
        [Category("Distortion"),DisplayName("LayoutType"),Description("理想点布点方法")]
        ...
        [Category("Distortion"),DisplayName("DistortionType"),Description("TV畸变H,V方向与光学畸变的检测方法")]
