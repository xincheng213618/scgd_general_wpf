...
namespace ColorVision.Template
{
    ...
    public class LedReusltParam : ParamBase
    {
        ...
        public float LLDetectionPX { set { SetProperty(value); } get => GetValue<float>(); }
        [Category("参数X判断配置"), DefaultValue(0),DisplayName("X下限检测阈值固定值")]
        public float LLDetectionFX { set { SetProperty(value); } get => GetValue<float>(); }
        [Category("参数X判断配置"), DefaultValue(1.8),DisplayName("X上限检测阈值百分比")]
        public float HLDetectionPX { set { SetProperty(value); } get => GetValue<float>(); }
        [Category("参数X判断配置"), DefaultValue(float.MaxValue), DisplayName("X上限检测阈值固定值")]
        public float HLDetectionFX { set { SetProperty(value); } get => GetValue<float>(); }

        [Category("参数Y判断配置"), DefaultValue(false),DisplayName("Y启用检测")]
        public bool IsYEnable { set { SetProperty(value); } get => GetValue<bool>(); }
        [Category("参数Y判断配置"), DefaultValue(0.2), DisplayName("Y下限检测阈值百分比")]
        public float LLDetectionPY { set { SetProperty(value); } get => GetValue<float>(); }
        [Category("参数Y判断配置"), DefaultValue(0),DisplayName("Y下限检测阈值固定值")]
        public float LLDetectionFY { set { SetProperty(value); } get => GetValue<float>(); }
        [Category("参数Y判断配置"), DefaultValue(1.8), DisplayName("Y上限检测阈值百分比")]
        public float HLDetectionPY { set { SetProperty(value); } get => GetValue<float>(); }
        [Category("参数Y判断配置"), DefaultValue(float.MaxValue), DisplayName("Y上限检测阈值固定值")]
        public float HLDetectionFY { set { SetProperty(value); } get => GetValue<float>(); }

        [Category("参数Z判断配置"), DefaultValue(false),DisplayName("Z启用检测")]
        public bool IsZEnable { set { SetProperty(value); } get => GetValue<bool>(); }
        [Category("参数Z判断配置"), DefaultValue(0.2), DisplayName("Z下限检测阈值百分比")]
        public float LLDetectionPZ { set { SetProperty(value); } get => GetValue<float>(); }
        [Category("参数Z判断配置"), DefaultValue(0), DisplayName("Z下限检测阈值固定值")]
        public float LLDetectionFZ { set { SetProperty(value); } get => GetValue<float>(); }
        [Category("参数Z判断配置"), DefaultValue(1.8), DisplayName("Z上限检测阈值百分比")]
        public float HLDetectionPZ { set { SetProperty(value); } get => GetValue<float>(); }
        [Category("参数Z判断配置"), DefaultValue(float.MaxValue), DisplayName("Z上限检测阈值固定值")]
        public float HLDetectionFZ { set { SetProperty(value); } get => GetValue<float>(); }

        [Category("参数x判断配置"), DefaultValue(false), DisplayName("x启用检测")]
        public bool IslxEnable { set { SetProperty(value); } get => GetValue<bool>(); }
        [Category("参数x判断配置"), DefaultValue(0.2), DisplayName("x下限检测阈值百分比")]
        public float LLDetectionPlx { set { SetProperty(value); } get => GetValue<float>(); }
        [Category("参数x判断配置"), DefaultValue(0), DisplayName("x下限检测阈值固定值")]
        public float LLDetectionFlx { set { SetProperty(value); } get => GetValue<float>(); }
        [Category("参数x判断配置"), DefaultValue(1.8), DisplayName("x上限检测阈值百分比")]
        public float HLDetectionPlx { set { SetProperty(value); } get => GetValue<float>(); }
        [Category("参数x判断配置"), DefaultValue(float.MaxValue), DisplayName("x上限检测阈值固定值")]
        public float HLDetectionFlx { set { SetProperty(value); } get => GetValue<float>(); }

        [Category("参数y判断配置"), DefaultValue(false), DisplayName("y启用检测")]
        public bool IslyEnable { set { SetProperty(value); } get => GetValue<bool>(); }
        [Category("参数y判断配置"), DefaultValue(0.2), DisplayName("y下限检测阈值百分比")]
        public float LLDetectionPly { set { SetProperty(value); } get => GetValue<float>(); }
        [Category("参数y判断配置"), DefaultValue(0), DisplayName("y下限检测阈值固定值")]
        public float LLDetectionFly { set { SetProperty(value); } get => GetValue<float>(); }
        [Category("参数y判断配置"), DefaultValue(1.8), DisplayName("y上限检测阈值百分比")]
        public float HLDetectionPly { set { SetProperty(value); } get => GetValue<float>(); }
        [Category("参数y判断配置"), DefaultValue(float.MaxValue), DisplayName("y上限检测阈值固定值")]
        public float HLDetectionFly { set { SetProperty(value); } get => GetValue<float>(); }

        [Category("参数u判断配置"), DefaultValue(false), DisplayName("u启用检测")]
        public bool IsluEnable { set { SetProperty(value); } get => GetValue<bool>(); }
        [Category("参数u判断配置"), DefaultValue(0.2), DisplayName("u下限检测阈值百分比")]
        public float LLDetectionPlu { set { SetProperty(value); } get => GetValue<float>(); }
        [Category("参数u判断配置"), DefaultValue(0), DisplayName("u下限检测阈值固定值")]
        public float LLDetectionFlu { set { SetProperty(value); } get => GetValue<float>(); }
        [Category("参数u判断配置"), DefaultValue(1.8), DisplayName("u上限检测阈值百分比")]
        public float HLDetectionPlu { set { SetProperty(value); } get => GetValue<float>(); }
        [Category("参数u判断配置"), DefaultValue(float.MaxValue), DisplayName("u上限检测阈值固定值")]
        public float HLDetectionFlu { set { SetProperty(value); } get => GetValue<float>(); }

        [Category("参数v判断配置"), DefaultValue(false), DisplayName("v启用检测")]
        public bool IslvEnable { set { SetProperty(value); } get => GetValue<bool>(); }
        [Category("参数v判断配置"), DefaultValue(0.2), DisplayName("v下限检测阈值百分比")]
        public float LLDetectionPlv { set { SetProperty(value); } get => GetValue<float>(); }
        [Category("参数v判断配置"), DefaultValue(0), DisplayName("v下限检测阈值固定值")]
        public float LLDetectionFlv { set { SetProperty(value); } get => GetValue<float>(); }
        [Category("参数v判断配置"), DefaultValue(1.8), DisplayName("v上限检测阈值百分比")]
        public float HLDetectionPlv { set { SetProperty(value); } get => GetValue<float>(); }
        [Category("参数v判断配置"), DefaultValue(float.MaxValue), DisplayName("v上限检测阈值固定值")]
        public float HLDetectionFlv { set { SetProperty(value); } get => GetValue<float>(); }

        [Category("参数CCT判断配置"), DefaultValue(false), DisplayName("CCT启用检测")]
        public bool IsCCTEnable { set { SetProperty(value); } get => GetValue<bool>(); }
        [Category("参数CCT判断配置"), DefaultValue(0.2), DisplayName("CCT下限检测阈值百分比")]
        public float LLDetectionPCCT { set { SetProperty(value); } get => GetValue<float>(); }
        [Category("参数CCT判断配置"), DefaultValue(0), DisplayName("CCT下限检测阈值固定值")]
        public float LLDetectionFCCT { set { SetProperty(value); } get => GetValue<float>(); }
        [Category("参数CCT判断配置"), DefaultValue(1.8), DisplayName("CCT上限检测阈值百分比")]
        public float HLDetectionPCCT { set { SetProperty(value); } get => GetValue<float>(); }
        [Category("参数CCT判断配置"), DefaultValue(float.MaxValue), DisplayName("CCT上限检测阈值固定值")]
        public float HLDetectionFCCT { set { SetProperty(value); } get => GetValue<float>(); }

        [Category("参数DW判断配置"), DefaultValue(false), DisplayName("DW启用检测")]
        public bool IsDWTEnable { set { SetProperty(value); } get => GetValue<bool>(); }
        [Category("参数DW判断配置"), DefaultValue(0.2), DisplayName("DW下限检测阈值百分比")]
        public float LLDetectionPDW { set { SetProperty(value); } get => GetValue<float>(); }
        [Category("参数DW判断配置"), DefaultValue(0), DisplayName("DW下限检测阈值固定值")]
        public float LLDetectionFDW { set { SetProperty(value); } get => GetValue<float>(); }
        [Category("参数DW判断配置"), DefaultValue(1.8), DisplayName("DW上限检测阈值百分比")]
        public float HLDetectionPDW { set { SetProperty(value); } get => GetValue<float>(); }
        [Category("参数DW判断配置"), DefaultValue(float.MaxValue), DisplayName("DW上限检测阈值固定值")]
        public float HLDetectionFDW { set { SetProperty(value); } get => GetValue<float>(); }

        [Category("参数亮度均匀性判断配置"), DefaultValue(false), DisplayName("亮度均匀性启用检测")]
        public bool IsBUEnable { set { SetProperty(value); } get => GetValue<bool>(); }
        [Category("参数亮度均匀性判断配置"), DefaultValue(0.2), DisplayName("亮度均匀性下限检测阈值百分比")]
        public float LLDetectionPBU { set { SetProperty(value); } get => GetValue<float>(); }
        [Category("参数亮度均匀性判断配置"), DefaultValue(0), DisplayName("亮度均匀性下限检测阈值固定值")]
        public float LLDetectionFBU { set { SetProperty(value); } get => GetValue<float>(); }
        [Category("参数亮度均匀性判断配置"), DefaultValue(1.8), DisplayName("亮度均匀性上限检测阈值百分比")]
        public float HLDetectionPBU { set { SetProperty(value); } get => GetValue<float>(); }
        [Category("参数亮度均匀性判断配置"), DefaultValue(float.MaxValue), DisplayName("亮度均匀性上限检测阈值固定值")]
        public float HLDetectionFBU { set { SetProperty(value); } get => GetValue<float>(); }

        [Category("参数色度均匀性判断配置"), DefaultValue(false), DisplayName("色度均匀性启用检测")]
        public bool IsCUEnable { set { SetProperty(value); } get => GetValue<bool>(); }
        [Category("参数色度均匀性判断配置"), DefaultValue(0.2), DisplayName("色度均匀性下限检测阈值百分比")]
        public float LLDetectionPCU { set { SetProperty(value); } get => GetValue<float>(); }
        [Category("参数色度均匀性判断配置"), DefaultValue(0), DisplayName("色度均匀性下限检测阈值固定值")]
        public float LLDetectionFCU { set { SetProperty(value); } get => GetValue<float>(); }
        [Category("参数色度均匀性判断配置"), DefaultValue(1.8), DisplayName("色度均匀性上限检测阈值百分比")]
        public float HLDetectionPCU { set { SetProperty(value); } get => GetValue<float>(); }
        [Category("参数色度均匀性判断配置"), DefaultValue(float.MaxValue), DisplayName("色度均匀性上限检测阈值固定值")]
        public float HLDetectionFCU { set { SetProperty(value); } get => GetValue<float>(); }

        [Category("检测判断配置"), DisplayName("判断方式"), Description("1-仅通过百分比阈值判断\r\n2-仅通过固定阈值判断\r\n3-结合两种方式同时判断") ]
        public int JudgingWay { set { SetProperty(value); } get => GetValue<int>(); }

        [Category("检测判断配置"), DisplayName("多参数判断方式"), Description("1-选定参数中有一个判断NG即返回NG\r\n2-当所有选定参数都判定NG时返回NG")  ]
        public int JudgingWayMul { set { SetProperty(value); } get => GetValue<int>(); }
    }
