...
namespace ColorVision.Update
{
    public class ChangeLogEntry : ViewModelBase
    {
        ...
        public string UpdateString => new Version(Version) > AutoUpdater.CurrentVersion ? Properties.Resources.Upgrade : Properties.Resources.Rollback;
        ...
        public ChangeLogEntry()
        {
            ...
            DownLoadCommand = new RelayCommand(a => PlatformHelper.Open($"{AutoUpdateConfig.Instance.ColorVisionUpdatePath}/ColorVision-{Version}.exe"));
