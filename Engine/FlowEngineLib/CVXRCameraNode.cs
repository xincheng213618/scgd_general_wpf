...
public class CVXRCameraNode : CVBaseServerNode
{
	...
	public CVXRCameraNode()
		: base("CV相机[XR]", "Camera", "SVR.Camera.Default", "DEV.Camera.Default")
	{
	...
	protected override object getBaseEventData(CVStartCFC start)
	{
		...
		return new CVXRCameraParam(_FlipMode, _EnableFocus, _Focus, _Aperture, _AvgCount, _Gain, expTime, _CalibTempName, _POITempName, _POIFilterTempName, _POIReviseTempName, _GlobalVariableName, operatorCodeXR, _XRTempName);
	}
