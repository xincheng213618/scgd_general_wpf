...
{
    /// <summary>
    /// Configuration for IvlCameraPostProcessor
    /// </summary>
    public class IvlCameraPostProcessorConfig : ViewModelBase
    {
    ...
    [PostProcess("IvlCameraProcessing", "ProcessAndExportCameraDataFromIvlBatchOnly")]
    public class IvlCameraPostProcessor : PostProcessorBase<IvlCameraPostProcessorConfig>
    {
        private static readonly ILog log = LogManager.GetLogger(nameof(IvlCameraPostProcessor));
