...
{
    /// <summary>
    /// Specifies metadata for an IPostProcessor implementation to provide better user experience
    ...
    public class PostProcessAttribute : Attribute
    {
        ...
        /// <summary>
        /// Initializes a new instance of the PostProcessAttribute class.
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the PostProcessAttribute class with a display name.
        /// </summary>
        /// <param name="displayName">The display name of the batch process.</param>
        public PostProcessAttribute(string displayName)
        {
        ...
        /// <summary>
        /// Initializes a new instance of the PostProcessAttribute class with a display name and description.
        /// </summary>
        /// <param name="displayName">The display name of the batch process.</param>
        /// <param name="description">The description of the batch process.</param>
        public PostProcessAttribute(string displayName, string description)
        {
            DisplayName = displayName ?? string.Empty;
