...
[STNode("/03_1 关注点")]
[STNodeSerializationModel("FlowEngineLib.dll|FlowEngineLib.Node.POI.POIAnalysisNode")]
public class POIAnalysisNode : CVBaseServerNode
{
	[STNodeProperty("参数模板", "参数模板", true)]
	[System.ComponentModel.PropertyEditorTypeAttribute(typeof(PoiAnalysisTemplatePropertiesEditor))]
