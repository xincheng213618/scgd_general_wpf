...
[STNode("/02 相机")]
[STNodeSerializationModel("FlowEngineLib.dll|FlowEngineLib.AOIRegisterPixelsCameraNode")]
public class AOIRegisterPixelsCameraNode : CVBaseServerNodeHub
{
	...
	private const string algParamType = "OLED_RebuildPixelsMem";
	...
	[PropertyEditorType(typeof(PoiOutputTemplatePropertiesEditor))]
	...
	public AOIRegisterPixelsCameraNode()
		: base("AOIRegisterPixels", "Camera", "SVR.Camera.Default", "DEV.Camera.Default")
	{
	...
	protected override object getBaseEventData(CVStartCFC start)
	{
		...
		return new CVAOIBVRegCameraParam(_ImgSaveName, _FlipMode, _AvgCount, _Gain, new float[1] { _ExpTime }, _IsWithND, _IsAutoExp, _AutoExpTempName, _CaliTempName, "OLED_RebuildPixelsMem", _AlgTempName, _Channel, _OutputTempName, algorithmPreStepParam.MasterId, (int)_ImgSaveMode);
	}
