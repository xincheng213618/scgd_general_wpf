...
namespace ColorVision.Engine.FlowProcessing.PreProcess
{
    ...
    /// Executes before the flow starts.
    /// </summary>
    public interface IPreProcessor
    {
        ...
        Task<bool> PreProcess(PreProcessContext ctx);
    ...
    public abstract class PreProcessorBase<T> : IPreProcessor where T : PreProcessConfigBase, new()
    {
        /// <summary>
        ...
        /// </summary>
        public abstract Task<bool> PreProcess(PreProcessContext ctx);
    }
}
