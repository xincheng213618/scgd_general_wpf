...
{
    /// <summary>
    /// Provides metadata information for an IPreProcessor implementation.
    /// </summary>
    public class PreProcessMetadata
    {
        ...
        /// </summary>
        /// <param name="type">The type implementing IPreProcessor.</param>
        /// <returns>A PreProcessMetadata instance containing the metadata.</returns>
