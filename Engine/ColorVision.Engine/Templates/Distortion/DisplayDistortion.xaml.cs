...
namespace ColorVision.Engine.Templates.Distortion
{
    ...
    /// </summary>
    public partial class DisplayDistortion : UserControl
    {
        public AlgorithmDistortion IAlgorithm { get; set; }
        public DisplayDistortion(AlgorithmDistortion iAlgorithm)
        {
        ...
        private void UserControl_Initialized(object sender, EventArgs e)
        {
            ...
            ComboxTemplate.ItemsSource = TemplateDistortionParam.Params;
