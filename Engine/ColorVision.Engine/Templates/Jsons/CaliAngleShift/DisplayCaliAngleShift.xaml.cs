...
{
    /// <summary>
    /// DisplayCaliAngleShift.xaml 的交互逻辑
    /// </summary>
    public partial class DisplayCaliAngleShift : UserControl
    {
        public AlgorithmCaliAngleShift IAlgorithm { get; set; }
        public DisplayCaliAngleShift(AlgorithmCaliAngleShift iAlgorithm)
        {
