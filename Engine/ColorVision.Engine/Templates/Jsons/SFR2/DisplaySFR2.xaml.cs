...
{
    /// <summary>
    /// DisplaySFR2.xaml 的交互逻辑
    /// </summary>
    public partial class DisplaySFR2 : UserControl
    {
        public AlgorithmSFR2 IAlgorithm { get; set; }
        public DisplaySFR2(AlgorithmSFR2 iAlgorithm)
        {
        ...
        private void UserControl_Initialized(object sender, EventArgs e)
        {
            ...
            ComboxTemplate.ItemsSource = TemplateSFR2.Params;
        ...
        {
            if (!ServicesHelper.IsTemplateSelected(ComboxTemplate, "请先选择SFR模板")) return;
