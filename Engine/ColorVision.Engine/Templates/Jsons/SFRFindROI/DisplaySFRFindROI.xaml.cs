...
namespace ColorVision.Engine.Templates.Jsons.SFRFindROI
{
    ...
    /// </summary>
    public partial class DisplaySFRFindROI : UserControl
    {
        public AlgorithmSFRFindROI IAlgorithm { get; set; }
        public DisplaySFRFindROI(AlgorithmSFRFindROI iAlgorithm)
        {
        ...
        private void RunTemplate_Click(object sender, RoutedEventArgs e)
        {
            ...
            if (GetAlgSN(out string sn, out string imgFileName, out FileExtType fileExtType))
            {
                ...
                ServicesHelper.SendCommand(msg, "正在执行SFR寻边算法");
            }
        }
