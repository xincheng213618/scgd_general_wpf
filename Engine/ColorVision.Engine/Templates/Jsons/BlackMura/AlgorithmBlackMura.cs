...
namespace ColorVision.Engine.Templates.Jsons.BlackMura
{
    public class AlgorithmBlackMura : ViewModelBase, IDisplayAlgorithm
    {
        ...
        {
            new TemplateEditorWindow(new TemplateBlackMura(), TemplateSelectedIndex) { Owner = Application.Current.GetActiveWindow(), WindowStartupLocation = WindowStartupLocation.CenterOwner }.Show();
        }
