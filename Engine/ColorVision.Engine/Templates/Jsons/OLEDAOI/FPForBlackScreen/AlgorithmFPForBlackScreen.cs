...
namespace ColorVision.Engine.Templates.Jsons.OLEDAOI.FPForBlackScreen
{
    ...
    public class AlgorithmFPForBlackScreen : DisplayAlgorithmBase
    {
        ...
        public AlgorithmFPForBlackScreen(DeviceAlgorithm deviceAlgorithm)
        {
        ...
        {
            new TemplateEditorWindow(new TemplateFPForBlackScreen(), TemplateSelectedIndex) { Owner = Application.Current.GetActiveWindow(), WindowStartupLocation = WindowStartupLocation.CenterOwner }.Show();
        }
        ...
        {
            UserControl ??= new DisplayFPForBlackScreen(this);
            return UserControl;
        }
