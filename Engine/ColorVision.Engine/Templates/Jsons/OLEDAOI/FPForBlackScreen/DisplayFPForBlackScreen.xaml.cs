...
{
    /// <summary>
    /// DisplayFPForBlackScreen.xaml 的交互逻辑
    /// </summary>
    public partial class DisplayFPForBlackScreen : UserControl
    {
        public AlgorithmFPForBlackScreen IAlgorithm { get; set; }
        public DisplayFPForBlackScreen(AlgorithmFPForBlackScreen iAlgorithm)
        {
        ...
        private void UserControl_Initialized(object sender, EventArgs e)
        {
            ...
            ComboxTemplate.ItemsSource = TemplateFPForBlackScreen.Params;
        ...
        {
            if (!ServicesHelper.IsTemplateSelected(ComboxTemplate, "请先选择黑画面检测模板")) return;
