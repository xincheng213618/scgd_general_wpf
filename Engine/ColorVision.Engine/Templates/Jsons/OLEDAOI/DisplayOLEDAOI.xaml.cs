...
{
    /// <summary>
    /// DisplayOLEDAOI.xaml 的交互逻辑
    /// </summary>
    public partial class DisplayOLEDAOI : UserControl
    {
        public AlgorithmOLEDAOI IAlgorithm { get; set; }
        public DisplayOLEDAOI(AlgorithmOLEDAOI iAlgorithm)
        {
        ...
        private void UserControl_Initialized(object sender, EventArgs e)
        {
            ...
            ComboxTemplate.ItemsSource = TemplateOLEDAOI.Params;
        ...
        {
            if (!ServicesHelper.IsTemplateSelected(ComboxTemplate, "请先选择OLED AOI模板")) return;
