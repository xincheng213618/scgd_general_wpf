...
{
    /// <summary>
    /// DisplayFPForRePicGradingV2.xaml 的交互逻辑
    /// </summary>
    public partial class DisplayFPForRePicGradingV2 : UserControl
    {
        public AlgorithmFPForRePicGradingV2 IAlgorithm { get; set; }
        public DisplayFPForRePicGradingV2(AlgorithmFPForRePicGradingV2 iAlgorithm)
        {
        ...
        private void UserControl_Initialized(object sender, EventArgs e)
        {
            ...
            ComboxTemplate.ItemsSource = TemplateFPForRePicGradingV2.Params;
        ...
        {
            if (!ServicesHelper.IsTemplateSelected(ComboxTemplate, "请先选择缺陷检测V2模板")) return;
