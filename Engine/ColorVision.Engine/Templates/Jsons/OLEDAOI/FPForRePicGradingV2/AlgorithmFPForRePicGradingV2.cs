...
namespace ColorVision.Engine.Templates.Jsons.OLEDAOI.FPForRePicGradingV2
{
    ...
    public class AlgorithmFPForRePicGradingV2 : DisplayAlgorithmBase
    {
        ...
        {
            new TemplateEditorWindow(new TemplateFPForRePicGradingV2(), TemplateSelectedIndex) { Owner = Application.Current.GetActiveWindow(), WindowStartupLocation = WindowStartupLocation.CenterOwner }.Show();
        }
        ...
        {
            UserControl ??= new DisplayFPForRePicGradingV2(this);
            return UserControl;
        }
