...
{
    /// <summary>
    /// DisplayImageROI.xaml 的交互逻辑
    /// </summary>
    public partial class DisplayImageROI : UserControl
    {
        public AlgorithmImageROI IAlgorithm { get; set; }
        public DisplayImageROI(AlgorithmImageROI iAlgorithm)
        {
        ...
        private void UserControl_Initialized(object sender, EventArgs e)
        {
            ...
            ComboxTemplate.ItemsSource = TemplateImageROI.Params;
        ...
        {
            if (!ServicesHelper.IsTemplateSelected(ComboxTemplate, "请先选择图像裁剪模板")) return;
