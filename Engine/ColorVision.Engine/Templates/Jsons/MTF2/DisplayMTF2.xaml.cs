...
namespace ColorVision.Engine.Templates.Jsons.MTF2
{
    ...
    /// </summary>
    public partial class DisplayMTF2 : UserControl
    {
        public AlgorithmMTF2 IAlgorithm { get; set; }
        public DisplayMTF2(AlgorithmMTF2 iAlgorithm)
        {
        ...
        {
            if (!AlgorithmHelper.IsTemplateSelected(ComboxTemplate, "请先选择MTF模板")) return;
