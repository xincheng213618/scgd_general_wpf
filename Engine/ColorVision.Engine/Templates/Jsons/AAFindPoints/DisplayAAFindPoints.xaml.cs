...
namespace ColorVision.Engine.Templates.Jsons.AAFindPoints
{
    ...
    /// </summary>
    public partial class DisplayAAFindPoints : UserControl
    {
        public AlgorithmAAFindPoints IAlgorithm { get; set; }
        public DisplayAAFindPoints(AlgorithmAAFindPoints iAlgorithm)
        {
        ...
        private void UserControl_Initialized(object sender, EventArgs e)
        {
            ...
            ComboxTemplate.ItemsSource = TemplateAAFindPoints.Params;
        ...
        {
            if (!AlgorithmHelper.IsTemplateSelected(ComboxTemplate, "请先选择寻找AA区模板")) return;
            ...
            if (GetAlgSN(out string sn, out string imgFileName, out FileExtType fileExtType))
            {
                ...
                ServicesHelper.SendCommand(msg, "正在执行寻找AA区算法");
            }
        }
