...
namespace ColorVision.Engine.Templates.Jsons.DataConvert
{
    ...
    /// </summary>
    public partial class DisplayDataConvert : UserControl
    {
        public AlgorithmDataConvert IAlgorithm { get; set; }
        public DisplayDataConvert(AlgorithmDataConvert iAlgorithm)
        {
        ...
        private void UserControl_Initialized(object sender, EventArgs e)
        {
            ...
            ComboxTemplate.ItemsSource = TemplateDataConvert.Params;
        ...
        {
            if (!AlgorithmHelper.IsTemplateSelected(ComboxTemplate, "请先选择数据转换模板")) return;
            ...
            if (GetAlgSN(out string sn, out string imgFileName, out FileExtType fileExtType))
            {
                ...
                ServicesHelper.SendCommand(msg, "正在执行数据转换算法");
            }
        }
