#pragma warning disable CA1725,CS8601,CS8602
    ...
    public class ViewHandleLEDStripDetectionV2 : IResultHandleBase
    {
        ...
        public override void Load(ViewResultContext ctx, ViewResultAlg result)
        {
            if (result.ViewResults == null)
            {
                ...
                result.ContextMenu.Items.Add(new MenuItem() { Header = Properties.Resources.Debug, Command = new RelayCommand(a => DisplayAlgorithmManager.GetInstance().SetType(new DisplayAlgorithmParam() { Type = typeof(AlgorithmLEDStripDetectionV2), ImageFilePath = result.FilePath })) });
            }
        }
