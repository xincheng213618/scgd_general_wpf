...
namespace ColorVision.Engine.Templates.Jsons.PoiAnalysis
{
    ...
    /// </summary>
    public partial class DisplayPoiAnalysis : UserControl
    {
        public AlgorithmPoiAnalysis IAlgorithm { get; set; }
        public DisplayPoiAnalysis(AlgorithmPoiAnalysis iAlgorithm)
        {
