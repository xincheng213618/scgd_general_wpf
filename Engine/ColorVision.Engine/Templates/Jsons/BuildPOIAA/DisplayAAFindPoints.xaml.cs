...
namespace ColorVision.Engine.Templates.Jsons.BuildPOIAA
{
    ...
    /// </summary>
    public partial class DisplayBuildPOIAA : UserControl
    {
        public AlgorithmBuildPOIAA IAlgorithm { get; set; }
        public DisplayBuildPOIAA(AlgorithmBuildPOIAA iAlgorithm)
        {
        ...
        private void UserControl_Initialized(object sender, EventArgs e)
        {
            ...
            ComboxTemplate.ItemsSource = TemplateBuildPOIAA.Params;
        ...
        {
            if (!AlgorithmHelper.IsTemplateSelected(ComboxTemplate, "请先选择AA布点模板")) return;
            ...
            if (GetAlgSN(out string sn, out string imgFileName, out FileExtType fileExtType))
            {
                ...
                ServicesHelper.SendCommand(msg, "正在执行AA布点算法");
            }
        }
