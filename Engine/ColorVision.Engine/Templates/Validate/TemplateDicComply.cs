    ...
    public class TemplateDicComply : ITemplate<DicComplyParam>
    {
        ...
        public override void Load()
        {
            ...
            if (MySqlSetting.Instance.IsUseMySql && MySqlSetting.IsConnect)
            {
                ...
                {
                    var models = SysDictionaryModMasterDao.Instance.GetAllByParam(new Dictionary<string, object>() { { "tenant_id", RbacManagerConfig.Instance.TenantId }, { "mod_type", mod_type }, { "is_delete", false } });
