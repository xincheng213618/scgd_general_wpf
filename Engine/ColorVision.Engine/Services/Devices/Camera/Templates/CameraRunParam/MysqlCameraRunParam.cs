...
namespace ColorVision.Engine.Services.Devices.Camera.Templates.CameraRunParam
{
    public class MysqlCameraRunParam : IMysqlCommand
    {
        ...
        public string GetRecover()
        {
            ...
            string t_scgd_sys_dictionary_mod_master = "INSERT INTO `t_scgd_sys_dictionary_mod_master` (`id`, `code`, `name`, `p_type`, `pid`, `mod_type`, `cfg_json`, `version`, `create_date`, `is_enable`, `is_delete`, `remark`, `tenant_id`) VALUES (20, 'Camera.RunParams', '相机参数', 0, NULL, 1, NULL, NULL, '2024-04-28 11:35:49', 1, 0, NULL, 0);\r\n";
