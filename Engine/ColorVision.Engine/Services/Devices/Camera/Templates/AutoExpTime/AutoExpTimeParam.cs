...
namespace ColorVision.Engine.Services.Devices.Camera.Templates.AutoExpTimeParam
{
    ...
    public class AutoExpTimeParam : ParamModBase
    {
        ...
        [LocalizedDisplayName(nameof(Resources.IsEnable)), LocalizedDescription(nameof(Resources.IsEnable))]
        public bool autoExpFlag { get => GetValue(_autoExpFlag); set { SetProperty(ref _autoExpFlag, value); } }
        private bool _autoExpFlag = true;

        [LocalizedDisplayName(nameof(Resources.StartTimeMs))]
        ...
        [LocalizedDisplayName(nameof(Resources.FrequencySyncHz))]
        ...
        [LocalizedDisplayName(nameof(Resources.SaturationPercent))]
        ...
        [LocalizedDisplayName(nameof(Resources.ADMax))]
        ...
        [LocalizedDisplayName(nameof(Resources.MaxPercent))]
        ...
        [LocalizedDisplayName(nameof(Resources.SaturationDifference))]
