...
namespace ColorVision.Engine.Services.Devices.Camera.Templates.AutoFocus
{
    public class AutoFocusParam : ParamModBase
    {
        ...
        [LocalizedDisplayName(nameof(Resources.EvaluationFunctionType)), LocalizedDescription(nameof(Resources.EvaluationFunctionType))]
        public EvaFunc EvaFunc { get => GetValue(_EvaFunc); set { SetProperty(ref _EvaFunc, value); } }
        private EvaFunc _EvaFunc = EvaFunc.Variance;


        [LocalizedDisplayName(nameof(Resources.StepSwingRange)), LocalizedDescription(nameof(Resources.StepSwingRangeDiscription))]
        ...
        [LocalizedDisplayName(nameof(Resources.StepReductionFactor)), LocalizedDescription(nameof(Resources.SecondStepFactor))]
        ...
        [LocalizedDisplayName(nameof(Resources.CurrentStepSize)), LocalizedDescription(nameof(Resources.InitialStepSize))]
        public int CurStep { get => GetValue(_CurStep); set { SetProperty(ref _CurStep, value); } }
        private int _CurStep = 5000;
        [LocalizedDisplayName(nameof(Resources.StopStepSize)), LocalizedDescription(nameof(Resources.Deprecated))]
