...
namespace ColorVision.Engine.Cache
{
    ...
    public class FileServerCfg : ViewModelBase
    {
        ...
        /// 数据基础路径
        /// </summary>
        [ColorVision.Engine.Utilities.LocalizedDisplayName(typeof(ColorVision.Engine.Properties.Resources), "DataBasicPath"), PropertyEditorType(typeof(TextSelectFolderPropertiesEditor))]
        ...
        /// 端口范围
        /// </summary>
        [ColorVision.Engine.Utilities.LocalizedDisplayName(typeof(ColorVision.Engine.Properties.Resources), "PortRange")]
        ...
        /// 保存天数
        /// </summary>
        [ColorVision.Engine.Utilities.LocalizedDisplayName(typeof(ColorVision.Engine.Properties.Resources), "RetentionDays")]
