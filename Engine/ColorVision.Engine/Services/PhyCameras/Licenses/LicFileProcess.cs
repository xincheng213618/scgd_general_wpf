...
namespace ColorVision.Engine.Services.PhyCameras.Licenses
{
    ...
    public class LicFileProcess : IFileProcessor
    {
        ...
        public bool Process(string filePath)
        {
            ...
            if (MessageBox.Show(string.Format(Properties.Resources.ImportLicenseConfirm, colorVisionLicense.DeviceMode), "ColorVision", MessageBoxButton.YesNo) == MessageBoxResult.No) return false;
