...
namespace cvColorVision
{
    public class KeyBoardDLL
    {
        ...
        [DllImport(LIBRARY_CVCAMERA, CallingConvention = CallingConvention.Cdecl)]
        public static extern float CM_CalculateHalo(IRECT keyRect, int outMOVE, int threadV, int haloSize, string savePath, ref uint gray);

        [DllImport(LIBRARY_CVCAMERA, CallingConvention = CallingConvention.Cdecl)]
        public static extern float CM_CalculateKey(IRECT keyRect, int inMOVE, int threadV, string path,ref uint gray);
