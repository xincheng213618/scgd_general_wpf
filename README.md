...
- [English entry](docs/en/index.md)
...
| `Test/` | xUnit、native helper、后端和脚本测试 |
...
更多验证范围见 [测试与验证交接手册](docs/02-developer-guide/testing.md)。
...
- 简体中文是完整文档和事实来源。
- 英文只保留精简入口、快速上手、开发入口和许可入口。
- 繁体中文、日文、韩文历史副本已从当前工作树移除；如确有交付需要，可从 Git 历史找回后重新维护。
