...
共 197 个主题；默认 CLI 搜索只返回 current，使用 `--all` 明确包含规划与历史。
...
| 源码根 | 目录分组 | 关联主题 |
| --- | ---: | ---: |
| [ColorVision](./code/source-ColorVision.md) | 13 | 54 |
| [UI](./code/source-UI.md) | 14 | 100 |
...
- [UI 与图像交互](./domains/ui.md) — 35 个主题；属性编辑器、窗口组件、图像交互和绘制扩展。
