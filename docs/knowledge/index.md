...
共 171 个主题；默认 CLI 搜索只返回 current，使用 `--all` 明确包含规划与历史。
...
| 源码根 | 目录分组 | 关联主题 |
| --- | ---: | ---: |
| [ColorVision](./code/source-ColorVision.md) | 8 | 36 |
| [UI](./code/source-UI.md) | 14 | 81 |
...
- [构建、测试与交付](./domains/delivery.md) — 23 个主题；克隆环境、构建依赖、测试、发布脚本和更新。
