...
共 189 个主题；默认 CLI 搜索只返回 current，使用 `--all` 明确包含规划与历史。
...
| 源码根 | 目录分组 | 关联主题 |
| --- | ---: | ---: |
| [ColorVision](./code/source-ColorVision.md) | 11 | 45 |
| [UI](./code/source-UI.md) | 14 | 94 |
| [Engine](./code/source-Engine.md) | 6 | 80 |
