...
本契約で明示的に許可されていない限り、お客様は以下の行為を行うことはできません。
- 本ソフトウェアをコピー、修正、翻訳、デコンパイル、逆設計、逆アセンブル、または他の方法でソースコードを発見しようとする行為。
- 本ソフトウェアまたは本契約で付与された権利をリース、リース、レンタル、譲渡、またはその他の方法で移転する行為。
- 本ソフトウェアに含まれる著作権表示またはその他の所有権表示を削除または修正する行為。

**3。所有権**

本ソフトウェアは時差によって所有および運営されています。お客様は、本ソフトウェアの使用権のみを付与され、本ソフトウェアの所有権を取得するものではありません。本ソフトウェアおよびそのすべてのコピーに対するすべての権利、所有権および利益は時差に帰属します。

**4。契約終了**

お客様が本契約の条件に違反した場合、本契約は予告なく自動的に終了します。終了後、お客様は直ちに本ソフトウェアの使用を中止し、本ソフトウェアのすべてのコピーを破棄するものとします。

**5。保証および免責事項**

本ソフトウェアは「現状のまま」提供され、時差は本ソフトウェアの性能または結果について明示的または黙示的な保証を行いません。これには、商品性、特定目的への適合性、非侵害に対する保証が含まれますが、これらに限定されません。時差は、本ソフトウェアがエラーなしまたは中断なしで動作することを保証しません。

**6。責任制限**

いかなる場合においても、時差は、本ソフトウェアの使用または使用不可に起因する間接的、特殊的、偶然的、懲罰的または結果的損害（利益損失、業務中断、情報損失を含むがこれらに限定されない）について責任を負いません。これは、時差がそのような損害の可能性を通知された場合でも同様です。

**7。準拠法**

本契約は、中華人民共和国の法律に準拠して解釈されます。法的衝突の原則は考慮されません。本契約に起因するまたは関連するすべての紛争は、時差の所在地管轄裁判所に提出されます。

**8。完全な契約**

本契約は、本契約の主題に関する当事者間の完全な契約を構成し、これに関する以前および現在のすべての口頭または書面による契約、声明および理解を置き換えます。

**9。修正と放棄**

本契約の修正または放棄は、書面で作成され、両当事者の正式な権限を持つ代表者が署名する必要があります。

**10。分離可能性**

本契約のいかなる条項も無効または執行不可能とみなされますが、残りの条項は引き続き完全な効力を持ちます。
