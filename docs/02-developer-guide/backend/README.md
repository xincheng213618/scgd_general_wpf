...
跨模块依赖、现有持久化接口和演进约束见[Web 架构](../../03-architecture/components/web.md)；本地启动脚本、NAS 更新步骤、备份和失败恢复见[Web 本地启动与 NAS 部署](../deployment/web.md)。
