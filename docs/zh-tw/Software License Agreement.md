...
請仔細閱讀本軟體許可協議（以下簡稱“協議”），該協議是您（個人或單一實體）與視彩（上海）光電技術有限公司（以下簡稱“視彩”）之間關於 ColrVision Inc 開發的 Windows WPF 軟體（以下簡稱“軟體”）的法律協議。安裝、複製或以其他方式使用本軟體，即表示您同意受本協議條款的約束。如果您不同意本協議的條款，請不要安裝或使用本軟體。

**1. 許可授予**

視彩授予您以下非排他性、不可轉讓的權利：
- 安裝和使用本軟體的一個副本，僅限用於您擁有或控制的單臺計算機上。
- 製作本軟體的一個備份副本，但僅限於備份或存檔目的。

**2. 許可限制**

除非本協議明確允許，您不得：
- 複製、修改、翻譯、反編譯、反向工程、反彙編或試圖以其他方式發現本軟體的原始碼。
- 出租、租賃、出借、轉讓或以其他方式轉讓本軟體或本協議授予的任何權利。
- 移除或修改本軟體中包含的任何版權宣告或其他所有權宣告。

**3. 所有權**

本軟體由ColorVision擁有和運營。您僅被授予使用本軟體的有限許可，而非對本軟體的所有權。本軟體及其所有副本的所有權利、所有權和利益均歸視彩所有。

**4. 終止**

如果您違反本協議的任何條款，本協議將自動終止，且無需視彩發出通知。終止後，您必須立即停止使用本軟體，並銷燬所有本軟體的副本。

**5. 保證和免責宣告**

本軟體按“現狀”提供，視彩不對本軟體的效能或結果作出任何明示或暗示的保證，包括但不限於適銷性、特定用途適用性和非侵權的保證。視彩不保證本軟體無錯誤或不中斷執行。

**6. 責任限制**

在任何情況下，視彩均不對因使用或不能使用本軟體而引起的任何間接、特殊、偶然、懲罰性或後果性損害（包括但不限於利潤損失、業務中斷、資訊丟失）承擔責任，即使視彩已被告知可能發生此類損害。
...
本協議構成雙方關於本協議主題的完整協議，並取代之前和當前關於該主題的所有口頭或書面的協議、宣告和諒解。
...
視彩授予您以下非排他性、不可轉讓的權利：
- 安裝和使用本軟體的一個副本，僅限於您擁有或控制的單臺計算機上。
- 製作本軟體的一個備份副本，但僅限於備份或存檔目的。

**2. 許可限制**

除非本協議明確允許，您不得：
- 複製、修改、翻譯、反編譯、反向工程、反匯編或試圖以其他方式發現本軟體的原始碼。
- 出租、租賃、出借、轉讓或以其他方式轉讓本軟體或本協議授予的任何權利。
- 移除或修改本軟體中包含的任何版權宣告或其他所有權宣告。

**3. 所有權**

本軟體由視彩擁有和運營。您僅被授予使用本軟體的有限許可，而非對本軟體的所有權。本軟體及其所有副本的所有權利、所有權和利益均歸視彩所有。

**4. 終止**

如果您違反本協議的任何條款，本協議將自動終止，且無需視彩發出通知。終止後，您必須立即停止使用本軟體，並銷毀所有本軟體的副本。
...
ColrVision grants you the following non-exclusive, non-transferable rights:
...
本ソフトウェア使用許諾契約（以下「契約」といいます）は、ColrVision Inc（以下「ColrVision」といいます）が開発したWindows WPFソフトウェア（以下「ソフトウェア」といいます）に関する、あなた（個人または単一の法人）と視彩（上海）光電技術有限公司（以下「視彩」といいます）との間の法的契約です。本ソフトウェアをインストール、コピー、またはその他の方法で使用することにより、あなたは本契約の條項に拘束されることに同意したものとみなされます。本契約の條項に同意しない場合は、本ソフトウェアをインストールまたは使用しないでください。

**1. 使用許諾の付與**

視彩は、以下の非獨佔的、非譲渡的権利をあなたに付與します：
...
- 本ソフトウェアまたは本契約で付與された権利を貸與、リース、貸し出し、譲渡、またはその他の方法で転送する行為。
- 本ソフトウェアに含まれる著作権表示またはその他の所有権表示を削除または変更する行為。

**3. 所有権**

本ソフトウェアは視彩によって所有および運営されています。あなたは本ソフトウェアの使用許諾を受けるのみであり、本ソフトウェアの所有権を取得するものではありません。本ソフトウェアおよびそのすべてのコピーに対するすべての権利、所有権、および利益は視彩に帰屬します。

**4. 契約の終了**

あなたが本契約のいずれかの條項に違反した場合、本契約は通知なしに自動的に終了します。終了後、あなたは直ちに本ソフトウェアの使用を中止し、本ソフトウェアのすべてのコピーを破棄しなければなりません。

**5. 保証および免責事項**

本ソフトウェアは「現狀のまま」提供され、視彩は本ソフトウェアの效能または結果について、明示または黙示の保証を行いません。これには、商品性、特定の目的への適合性、および非侵害の保証が含まれますが、これに限りません。視彩は本ソフトウェアがエラーなしにまたは中斷なく動作することを保証しません。

**6. 責任の制限**

視彩は、本ソフトウェアの使用または使用不能に起因する間接的、特別、偶発的、懲罰的、または結果的損害（利益の損失、業務の中斷、情報の喪失を含むがこれに限らない）について、たとえ視彩がそのような損害の可能性を知らされていたとしても、一切の責任を負いません。

**7. 準拠法**

本契約は、中華人民共和國の法律に準拠し、その解釈に従って行われます。法律の牴觸原則は考慮されません。本契約に起因するまたは関連するすべての紛爭は、視彩の所在地にある管轄裁判所に提出されるものとします。

**8. 完全な契約**

本契約は、本契約の主題に関する當事者間の完全な契約を構成し、これに関する以前および現在のすべての口頭または書面による契約、宣告、および理解に取って代わります。

**9. 修正および放棄**

本契約の修正または放棄は、書面で行われ、両當事者の正式な権限を有する代表者によって署名されなければ有効になりません。

**10. 分離可能性**

本契約のいずれかの條項が無効または執行不能と見なされた場合でも、殘りの條項は完全に効力を持ち続けます。
