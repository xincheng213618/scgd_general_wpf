...
namespace Pattern.Solid
{
    ...
    public class PatternSolodConfig:ViewModelBase,IConfig
    {
        ...
        [DisplayName("主色"), PropertyEditorType(typeof(PatternBrushPropertiesEditor))]
        public SolidColorBrush MainBrush { get => _MainBrush; set { _MainBrush = value; OnPropertyChanged(); OnPropertyChanged(nameof(Tag)); } }
        private SolidColorBrush _MainBrush = Brushes.White;

        [Browsable(false)]
        public string Tag => MainBrush.ToColorTag();
