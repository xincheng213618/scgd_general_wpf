...
namespace Pattern.LinePairMTF
{
    ...
    public class PatternLinePairMTFConfig : ViewModelBase, IConfig
    {
        ...
        public SolidColorBrush LineBrush { get => _LineBrush; set { _LineBrush = value; OnPropertyChanged(); OnPropertyChanged(nameof(LineBrushTag)); } }
        private SolidColorBrush _LineBrush = Brushes.Black;

        [DisplayName("背景色"), PropertyEditorType(typeof(PatternBrushPropertiesEditor))]
        public SolidColorBrush BackgroundBrush { get => _BackgroundBrush; set { _BackgroundBrush = value; OnPropertyChanged(); OnPropertyChanged(nameof(BackgroundBrushTag)); } }
        ...
        [Browsable(false)]
        public string LineBrushTag => LineBrush.ToColorTag();
        
        [Browsable(false)]
        public string BackgroundBrushTag => BackgroundBrush.ToColorTag();
