namespace ColorVision.ImageEditor
{
    ...
    public static class ImageViewPropertyKeys
    {
        ...
        public const string ColorVisionSchema = "ColorVision.Schema";
        public const string ColorVisionSourceType = "ColorVision.SourceType";
        public const string ColorVisionExportedChannel = "ColorVision.ExportedChannel";
        public const string ColorVisionInputFileName = "ColorVision.InputFileName";
        public const string ColorVisionAssociatedSourceFileName = "ColorVision.AssociatedSourceFileName";
        public const string ColorVisionFileVersion = "ColorVision.FileVersion";
        public const string ColorVisionRows = "ColorVision.Rows";
        public const string ColorVisionCols = "ColorVision.Cols";
        public const string ColorVisionBpp = "ColorVision.Bpp";
        public const string ColorVisionSourceChannels = "ColorVision.SourceChannels";
        public const string ColorVisionNdPort = "ColorVision.NDPort";
        public const string ColorVisionGain = "ColorVision.Gain";
        public const string ColorVisionExposure = "ColorVision.Exposure";
