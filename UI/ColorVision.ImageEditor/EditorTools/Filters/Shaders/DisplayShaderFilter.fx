...
float4 ChannelOrderRed : register(c22);
float4 ChannelOrderGreen : register(c23);
float4 ChannelOrderBlue : register(c24);
...
{
    return float3(
        dot(rgb, ChannelOrderRed.rgb),
        dot(rgb, ChannelOrderGreen.rgb),
        dot(rgb, ChannelOrderBlue.rgb));
}
