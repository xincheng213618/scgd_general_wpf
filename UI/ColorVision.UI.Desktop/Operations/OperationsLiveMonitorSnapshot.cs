namespace ColorVision.UI.Desktop.Operations
{
    ...
    public sealed class OperationsLiveMonitorSnapshot
    {
        ...
        public string PrivacyNotice { get; init; } =
            "This live snapshot contains aggregate flow state, process counters, UI latency, and alert counts only. It excludes flow, template, batch, node, parameter, result, process identity, host, user, endpoint, log text, and inspection data.";
    }
