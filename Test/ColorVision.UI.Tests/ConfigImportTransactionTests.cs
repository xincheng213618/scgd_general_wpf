...
public sealed class ConfigImportTransactionTests : IDisposable
{
    ...
    public void InvalidImportNeverOverwritesOrRecoversRegardlessOfBackupAvailability(bool hasBackup)
    {
        ...
        Authorization c1Authorization = handler.GetRequiredService<Authorization>();
        ...
        Assert.Same(c1Authorization, handler.GetRequiredService<Authorization>());
        Assert.Same(c1Authorization, Authorization.Instance);
