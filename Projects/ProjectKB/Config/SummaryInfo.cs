...
namespace ProjectKB.Config
{
    public class SummaryInfo : ViewModelBase
    {
        ...
        /// </summary>
        [JsonIgnore]
        public double GoodProductRate { get => ActualProduction > 0 ? GoodProductCount / ActualProduction : 0; }

        /// <summary>
        /// 不良率
        /// </summary>
        [JsonIgnore]
        public double DefectiveProductRate { get => ActualProduction > 0 ? DefectiveProductCount / ActualProduction : 0; }
