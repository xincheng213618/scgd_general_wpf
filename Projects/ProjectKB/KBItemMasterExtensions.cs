...
namespace ProjectKB
{
            ...
            List<string> properties = new()
    {
        ...
        "MinInterKeyColorUniformity"
            ...
            int lvFailures = item.Items.Count(key =>
                (recipe.EnableKeyLvLimit && key.Lv < recipe.MinKeyLv)
                || (recipe.EnableKeyLvLimit && key.Lv > recipe.MaxKeyLv)
                || (recipe.EnableAvgLvLimit && item.AvgLv < recipe.MinAvgLv)
                || (recipe.EnableAvgLvLimit && item.AvgLv > recipe.MaxAvgLv));
