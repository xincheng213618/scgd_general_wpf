...
namespace ProjectARVR
{
    public class ViewResultManagerConfig : ViewModelBase, IConfig
    {
        ...
        [DisplayName("Csv保存路径"), Category("ARVR")]
        ...
        [DisplayName("Text保存路径"), Category("ARVR")]
    ...
    public class ViewResultManager : ViewModelBase,IDisposable
    {
        ...
        public static string SqliteDbPath { get; set; } = Path.Combine(DirectoryPath, "ProjectARVR.db");
