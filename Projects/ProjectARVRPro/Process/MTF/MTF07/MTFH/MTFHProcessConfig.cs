...
{
    public sealed class MTFHProcessConfig : ProcessConfigBase<MTFHRecipeConfig>, IMTF07DynamicProcessConfig
    {
        [Category("输出配置")]
        [DisplayName("输出Key")]
        [Description("写入DynamicTestResults的Key；多个MTF07-H画面应配置不同Key。")]
        public string Key { get => _Key; set { _Key = value; OnPropertyChanged(); } }
        private string _Key = "MTFH";
        ...
        public string GetOutputKey() => KeyedTestResultDictionary.NormalizeKey(Key, "MTFH");
    }
}
