...
{
    /// <summary>
    /// 058测试点位方案的横条纹MTFH解析 - 使用 MTFResult.result + mtfValue。
    /// H表示横条纹，与HV特殊图案流程相互独立。
    /// </summary>
                    ...
                    if (details.Count == 1)
                    {
                        ...
                        foreach (var mtf in mtfDetail.MTFResult.result)
                        {
                            if (mtf.name == Config.Key_Center_0F)
                            {
                                ...
                                testResult.MTF_H_Center_0F.Value = recipeConfig.MTF_H_Center_0F.Apply(testResult.MTF_H_Center_0F.Value);
                            ...
                            else if (mtf.name == Config.Key_LeftUp_0_5F)
                            {
                                ...
                                testResult.MTF_H_LeftUp_0_5F.Value = recipeConfig.MTF_H_LeftUp_0_5F.Apply(testResult.MTF_H_LeftUp_0_5F.Value);
                            ...
                            else if (mtf.name == Config.Key_RightUp_0_5F)
                            {
                                ...
                                testResult.MTF_H_RightUp_0_5F.Value = recipeConfig.MTF_H_RightUp_0_5F.Apply(testResult.MTF_H_RightUp_0_5F.Value);
                            ...
                            else if (mtf.name == Config.Key_LeftDown_0_5F)
                            {
                                ...
                                testResult.MTF_H_LeftDown_0_5F.Value = recipeConfig.MTF_H_LeftDown_0_5F.Apply(testResult.MTF_H_LeftDown_0_5F.Value);
                            ...
                            else if (mtf.name == Config.Key_RightDown_0_5F)
                            {
                                ...
                                testResult.MTF_H_RightDown_0_5F.Value = recipeConfig.MTF_H_RightDown_0_5F.Apply(testResult.MTF_H_RightDown_0_5F.Value);
                            ...
                            else if (mtf.name == Config.Key_LeftUp_0_8F)
                            {
                                ...
                                testResult.MTF_H_LeftUp_0_8F.Value = recipeConfig.MTF_H_LeftUp_0_8F.Apply(testResult.MTF_H_LeftUp_0_8F.Value);
                            ...
                            else if (mtf.name == Config.Key_RightUp_0_8F)
                            {
                                ...
                                testResult.MTF_H_RightUp_0_8F.Value = recipeConfig.MTF_H_RightUp_0_8F.Apply(testResult.MTF_H_RightUp_0_8F.Value);
                            ...
                            else if (mtf.name == Config.Key_LeftDown_0_8F)
                            {
                                ...
                                testResult.MTF_H_LeftDown_0_8F.Value = recipeConfig.MTF_H_LeftDown_0_8F.Apply(testResult.MTF_H_LeftDown_0_8F.Value);
                            ...
                            else if (mtf.name == Config.Key_RightDown_0_8F)
                            {
                                ...
                                testResult.MTF_H_RightDown_0_8F.Value = recipeConfig.MTF_H_RightDown_0_8F.Apply(testResult.MTF_H_RightDown_0_8F.Value);
