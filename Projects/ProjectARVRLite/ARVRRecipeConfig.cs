...
namespace ProjectARVRLite
{
    ...
    public class ARVRRecipeConfig : ViewModelBase, IRecipe
    {
        ...
        public double W255LuminanceUniformityMin { get => _W255LuminanceUniformityMin; set { _W255LuminanceUniformityMin = value; NotifyPropertyChanged(); } }
        private double _W255LuminanceUniformityMin = 0.75;
        [Category("W255")]
        [DisplayName("Luminance uniformity(%) Max")]
        public double W255LuminanceUniformityMax { get => _W255LuminanceUniformityMax; set { _W255LuminanceUniformityMax = value; NotifyPropertyChanged(); } }
