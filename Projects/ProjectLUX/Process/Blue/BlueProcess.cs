    ...
    public class BlueProcess : IProcess
    {
        ...
        public void Render(IProcessExecutionContext ctx)
        {
            ...
            foreach (var poiResultCIExyuvData in BlueTestResult.PoixyuvDatas)
            {
                ...
                PoiOverlayRenderer.Add(ctx.ImageView, item, CVRawOpen.FormatMessage(CVCIEShowConfig.Instance.Template, poiResultCIExyuvData), new PoiOverlayStyle { Stroke = Brushes.Blue });
            }
