...
{
    public class Chessboard55RecipeConfig : ViewModelBase, IRecipeConfig
    {
        [Category("Chessboard")]
        ...
        [Category("Chessboard")] public RecipeBase P17Lv { get => _P17Lv; set { _P17Lv = value; OnPropertyChanged(); } }
        private RecipeBase _P17Lv = new RecipeBase(0, 0);
        [Category("Chessboard")] public RecipeBase P18Lv { get => _P18Lv; set { _P18Lv = value; OnPropertyChanged(); } }
        private RecipeBase _P18Lv = new RecipeBase(0, 0);
        [Category("Chessboard")] public RecipeBase P19Lv { get => _P19Lv; set { _P19Lv = value; OnPropertyChanged(); } }
        private RecipeBase _P19Lv = new RecipeBase(0, 0);
        [Category("Chessboard")] public RecipeBase P20Lv { get => _P20Lv; set { _P20Lv = value; OnPropertyChanged(); } }
        private RecipeBase _P20Lv = new RecipeBase(0, 0);
        [Category("Chessboard")] public RecipeBase P21Lv { get => _P21Lv; set { _P21Lv = value; OnPropertyChanged(); } }
        private RecipeBase _P21Lv = new RecipeBase(0, 0);
        [Category("Chessboard")] public RecipeBase P22Lv { get => _P22Lv; set { _P22Lv = value; OnPropertyChanged(); } }
        private RecipeBase _P22Lv = new RecipeBase(0, 0);
        [Category("Chessboard")] public RecipeBase P23Lv { get => _P23Lv; set { _P23Lv = value; OnPropertyChanged(); } }
        private RecipeBase _P23Lv = new RecipeBase(0, 0);
        [Category("Chessboard")] public RecipeBase P24Lv { get => _P24Lv; set { _P24Lv = value; OnPropertyChanged(); } }
        private RecipeBase _P24Lv = new RecipeBase(0, 0);
        [Category("Chessboard")] public RecipeBase P25Lv { get => _P25Lv; set { _P25Lv = value; OnPropertyChanged(); } }
        private RecipeBase _P25Lv = new RecipeBase(0, 0);
    }
}