...
{
    public class Chessboard55FixConfig : ViewModelBase, IFixConfig
    {
        [Category("Chessboard")]
        ...
        [Category("Chessboard")] public double P17Lv { get => _P17Lv; set { _P17Lv = value; OnPropertyChanged(); } }
        private double _P17Lv = 1;
        [Category("Chessboard")] public double P18Lv { get => _P18Lv; set { _P18Lv = value; OnPropertyChanged(); } }
        private double _P18Lv = 1;
        [Category("Chessboard")] public double P19Lv { get => _P19Lv; set { _P19Lv = value; OnPropertyChanged(); } }
        private double _P19Lv = 1;
        [Category("Chessboard")] public double P20Lv { get => _P20Lv; set { _P20Lv = value; OnPropertyChanged(); } }
        private double _P20Lv = 1;
        [Category("Chessboard")] public double P21Lv { get => _P21Lv; set { _P21Lv = value; OnPropertyChanged(); } }
        private double _P21Lv = 1;
        [Category("Chessboard")] public double P22Lv { get => _P22Lv; set { _P22Lv = value; OnPropertyChanged(); } }
        private double _P22Lv = 1;
        [Category("Chessboard")] public double P23Lv { get => _P23Lv; set { _P23Lv = value; OnPropertyChanged(); } }
        private double _P23Lv = 1;
        [Category("Chessboard")] public double P24Lv { get => _P24Lv; set { _P24Lv = value; OnPropertyChanged(); } }
        private double _P24Lv = 1;
        [Category("Chessboard")] public double P25Lv { get => _P25Lv; set { _P25Lv = value; OnPropertyChanged(); } }
        private double _P25Lv = 1;
    }
