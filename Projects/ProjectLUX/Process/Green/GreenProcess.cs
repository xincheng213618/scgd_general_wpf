    ...
    public class GreenProcess : IProcess
    {
        ...
        public void Render(IProcessExecutionContext ctx)
        {
            ...
            foreach (var poiResultCIExyuvData in GreenTestResult.PoixyuvDatas)
            {
                ...
                PoiOverlayRenderer.Add(ctx.ImageView, item, CVRawOpen.FormatMessage(CVCIEShowConfig.Instance.Template, poiResultCIExyuvData), new PoiOverlayStyle { Stroke = Brushes.Green });
            }
