...
namespace ColorVision.Draw
{
    public class DrawingVisualRectangleWord : DrawingVisualRectangle, IRectangle
    {
        public override void Render()
        {
            ...
            FormattedText formattedText = new("Point_" + ID.ToString(), CultureInfo.CurrentCulture, FlowDirection.LeftToRight, new Typeface(fontFamily, FontStyles.Normal, FontWeights.Normal, FontStretches.Normal), fontSize, brush, VisualTreeHelper.GetDpi(this).PixelsPerDip);
